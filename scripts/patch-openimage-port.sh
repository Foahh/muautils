...
OVERLAY_DIR="$SCRIPT_DIR/openimageio-port-overlay"
SRC_PORT="ports/openimageio"
...
usage() {
    echo "Usage: $0 [--help|-h]"
    echo ""
    echo "  Clean ports/openimageio, copy ${SRC_PORT} from the vcpkg checkout, then apply"
    echo "  patches from ${OVERLAY_DIR}/ (see muautils-openimageio.patch)."
    echo ""
    echo "  Environment:"
