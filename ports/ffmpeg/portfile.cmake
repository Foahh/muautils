...
if ("custom" IN_LIST FEATURES)
    ...
    set(OPTIONS "${OPTIONS} --disable-avdevice --disable-swscale")
    set(OPTIONS "${OPTIONS} --disable-schannel --disable-mediafoundation")
    set(OPTIONS "${OPTIONS} --disable-d3d11va --disable-d3d12va --disable-dxva2")
    ...
    set(OPTIONS "${OPTIONS} --enable-filter=ebur128,loudnorm,adelay,atrim,aformat,aresample,asetpts")
endif ()
